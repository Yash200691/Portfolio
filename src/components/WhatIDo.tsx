        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                stack and Next.js, with REST APIs, WebSockets, and cloud
                infrastructure.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build applied machine learning tools and computer vision
                systems using deep learning frameworks and real-time processing.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
